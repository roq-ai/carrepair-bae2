...
import { getGarageById } from 'apiSdk/garages';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('garage', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/garages/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('service', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/services/create?garage_id=${data?.id}`}>
